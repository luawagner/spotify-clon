...
<img src={image} alt={title} />
        ...
        <span className="text-xs opacity-80"> 
         ...
         //Ponemos artists?.join porque al principio es null
    )
}
...
const { currentMusic, isPlaying, setIsPlaying, volume } = usePlayerStore(state => state) //Pedimos el estado global y las funciones para actualizarlo
